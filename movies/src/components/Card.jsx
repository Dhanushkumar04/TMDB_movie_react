...
import {Link} from 'react-router-dom'
 export const Card = ({movie}) => {
  const {poster_path,title,overview,popularity ,vote_average,vote_count,id}=movie
  const image=poster_path?`https://image.tmdb.org/t/p/original${poster_path}`: movie;
  return (
    <div className='col'>
